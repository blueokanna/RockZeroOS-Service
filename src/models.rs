...
use crate::zkp::PasswordProofData;
...
pub struct InviteCode {
    ...
    pub created_at_mono: i64,  // 单调时钟时间戳（纳秒）
    pub expires_at_mono: i64,  // 单调时钟过期时间
    pub created_at: DateTime<Utc>,
    pub is_used: bool,
...
pub struct MediaItem {
    ...
    pub file_id: String,
    pub title: String,
    pub media_type: String,  // audio, video, image
...
pub struct Widget {
    pub id: String,
    pub user_id: String,
    pub widget_type: String,  // clock, weather, notes, system_monitor
    pub title: String,
